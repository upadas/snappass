...
- Added a Vercel catch-all API function for `/api/*`, included passport spec markdown files in the serverless bundle, and declared explicit static routes for the home page and assets.
